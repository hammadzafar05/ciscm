                    ...
                    <div  >
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                @foreach($getAmbassador as $key=>$item)
                                    <tr>
                                        <td>{{ $key+1 }}</td>
                            ...
                            <div class="pagination-wrapper"> {!! clean( $getAmbassador->appends(['search' => Request::get('search')])->render() ) !!} </div>
                        </div>
