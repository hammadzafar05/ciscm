...
@endsection
@section('pageTitle',__('default.blog'))
@section('innerTitle',__('default.create-new').' '.__('default.blog-post'))
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12">
                <div>
                    <div>
                        <a href="{{ url('/admin/blog-posts') }}" title="@lang('default.back')">
                            <button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> @lang('default.back')</button>
                        </a>
                        <br/>
                        <br/>
...
@section('footer')
    ...
    <script src="{{ asset('client/app/blog.js') }}?re"></script>
