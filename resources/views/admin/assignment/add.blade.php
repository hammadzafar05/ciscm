...
@section('content')
    <div ng-app="myApp" ng-controller="myCtrl">
        <div>
            <div class="card">
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data" action="{{ adminUrl(array('controller'=>'assignment','action'=>$action,'id'=>$id)) }}">
                        @csrf
                        ...
                        {{--<div class="form-group  scheduled">
                            {{ formLabel($form->get('due_time')) }}
                            {{ formElement($form->get('due_time')) }} <p class="help-block">{{ formElementErrors($form->get('due_time')) }}</p>
                        ...
                        <div class="form-group">
                            {{ formElement($form->get('capston')) }} {{ formLabel($form->get('capston')) }}
                        </div>
                        ...
                        <div class="form-group">
                            <input type="file" name="assignment_file" id="assignment_file" accept="application/pdf, application/vnd.ms-excel,application/pdf,application/msword,
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        function checkSchedule() {
            ...
            if (type == 's') {
                $('.scheduled').show();
                $('.scheduled').find('select,input').attr('disabled', false);
                $('.post-class').find('select,input').attr('disabled', true);
            } else {
                $('.post-class').show();
                $('.scheduled').find('select,input').attr('disabled', true);
                $('.post-class').find('select,input').attr('disabled', false);
            }
        }
