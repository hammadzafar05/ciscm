                ...
                <div id="course_wizard" class="form_wizard wizard_horizontal">
                    ...
                    <div id="step-1">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="password1" class="control-label">Session Categories ({{ __lang('optional') }})</label>
                                    <div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div >
                                        <label for="password1" class="control-label">{{ __lang('session-description') }} (Important Information)</label>
                                    </div>
                                    <div >
                                ...
                                <div class="form-group">
                                    <div>
                                        <label for="module_description"
                                               class="control-label">
                                            {{ __lang('module_description') }} <i>(Note: Also used on Transcript)</i>
                                        </label>
                                    </div>
                                    <div>
                    ...
                    <div id="step-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div >
                                        <label for="password1" class="control-label">Regular Fee</label>
                                    </div>
                                    <div >
