    ...
    <div class="card">
        ...
        <div class="card-body">
            <form onsubmit="return confirm('You are about to import external certificates')"
                  ...
                  class="form"
                  method="post"
                  action="{{ route('admin.external_certificates.import') }}">
                @csrf
                <p>
                    Download the CSV template file here: <a href="<?php echo basePath().'/client/data/sample_external_certificates.csv';?>"> sample.csv </a>. Ensure that you do not modify the column names.
                </p>
