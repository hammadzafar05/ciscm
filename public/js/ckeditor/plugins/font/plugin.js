 ...
 * @member CKEDITOR.config
 */
CKEDITOR.config.fontSize_sizes = '8/8px;9/9px;10/10px;11/11px;12/12px;13/13px;14/14px;15/15px;16/16px;17/17px;18/18px;19/19px;20/20px;21/21px,22/22px;23/23px,24/24px;26/26px;28/28px;36/36px;48/48px;72/72px';
CKEDITOR.config.fontSize_sizes = '13/13px;11/11px;12/12px;14/14px;15/15px;';
/**
...
//CKEDITOR.config.fontSize_defaultLabel = '13';
/**
