        ...
        e.VERSION = "1.9.3", e.DEFAULTS = {
            ...
            constructor: e, init: function () {
                ...
                var d = this, e = [], f = 0, g = document.createElement("option"), h = -1, i = function (a, b, c, d) {
                    ...
                    return '<a tabindex="0"' + ("undefined" != typeof e ? ' class="' + e + '"' : "") + ("undefined" != typeof f ? ' style="' + f + '"' : "") + (d.options.liveSearchNormalize ? ' data-normalized-text="' + b(c(a)) + '"' : "") + ("undefined" != typeof g || null !== g ? ' data-tokens="' + g + '"' : "") + ">" + a + '<span class="1 ' + d.options.iconBase + " " + d.options.tickIcon + ' check-mark"></span></a>'
                };
                ...
                return this.$element.find("option").each(function (b) {
                    ...
                    if (h++, !c.hasClass("bs-title-option")) {
                        var g = this.className || "", k = this.style.cssText,
                            ...
                            //o = "undefined" != typeof c.data("icon") ? '<span class="2 ' + d.options.iconBase + " " + c.data("icon") + '"></span> ' : "",
                            o = "undefined" != typeof c.data("icon") ? '<img src="' + c.data("icon") + '" width="30px"> ' : "",
                        ...
                        if (c.data("content") || (l = o + '<span class="text">' + l + n + "</span>"), "OPTGROUP" === this.parentNode.tagName && c.data("divider") !== !0) {
                            ...
                            if (0 === c.index()) {
                                ...
                                var r = this.parentNode.label,
                                    ...
                                    t = c.parent().data("icon") ? '<span class="3 ' + d.options.iconBase + " " + c.parent().data("icon") + '"></span> ' : "";
