...
@section('content')
    ...
    <section class="ftco-section bg-light">
        <div class="container">
			...
			['show_at_success_stories', '1'],
		])->orderBy('publish_date','desc')->limit(5)->get() as $post)
                                ...
                                <div class="block-21 mb-4 d-flex">
                                    ...
                                    <div class="text">
                                        <h3 class="heading"><a href="{{ route('success_story.story',['blogPost'=>$post->id,'slug'=>safeUrl($post->title)]) }}">{{ $post->title }}</a></h3>
                                        <div class="meta">
