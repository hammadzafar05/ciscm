...
{{--MARUF END--}}
@section('crumb')
    <span><a href="@route('sessions')">{{ __lang('upcoming-sessions') }}</a></span>
    <span>/</span>
    <span><a href="#">{{ __lang('session-details') }}</a></span>
@endsection
@section('content')
                    ...
                    <ul class="nav nav-pills mb-2" id="myTab3" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                               ...
                               aria-controls="home"
                               aria-selected="true">
                                <i class="fa fa-info-circle"></i> Important Information{{-- {{  __lang('details')  }}--}}
                            </a>
                        </li>
                        @if($row->module_description != '')
                            <li class="nav-item">
                                <a class="nav-link"
                                   ...
                                   aria-selected="false">
                                    <i class="fa fa-info-circle"></i> {{  __lang('module_description')  }}
                                </a>
                            </li>
                        @endif
                        <li class="nav-item">
                            <a class="nav-link"
                               ...
                               aria-selected="false" style="display: none">
                                <i class="fa fa-table"></i> {{  __lang('classes')  }}
                            </a>
                        </li>
                        @if($row->outcomes != '')
                            <li class="nav-item">
                        ...
                        @if($instructors->count() > 0)
                            <li class="nav-item">
                                <a class="nav-link"
                                   ...
                                   aria-controls="contact"
                                   aria-selected="false">
                                    <i class="fa fa-table"></i> {{  __lang('instructors')  }}
                                </a>
                            </li>
                        @endif
                    </ul>
